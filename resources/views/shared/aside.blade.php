  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      @php
        ...
        $periodoActual    = \Carbon\Carbon::now()->format('Y-m');                 // Ej: 2025-09
        $periodoSiguiente = \Carbon\Carbon::now()->addMonthNoOverflow()->format('Y-m'); // Ej: 2025-10
      @endphp
      ...
      <ul id="varios-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
        ...
        <li>
          <a href="{{ route('periodos.index', ['periodo' => $periodoSiguiente]) }}">
            <i class="bi bi-people" style="font-size: 1em;"></i>
            <span>Activos siguiente período ({{ $periodoSiguiente }})</span>
          </a>
        </li>

        <li>
          <a href="{{ route('recibos.pendientes', ['periodo' => $periodoActual]) }}">
            <i class="bi bi-list-check" style="font-size: 1em;"></i>
            <span>Pendientes de recibo ({{ $periodoActual }})</span>
          </a>
        </li>

        <li>
          <a href="{{ route('recibos.retirosMasivos.form') }}">
            <i class="bi bi-person-dash" style="font-size: 1em;"></i>
            <span>Retiros masivos (pendientes)</span>
          </a>
        </li>
