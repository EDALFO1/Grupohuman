...
Route::middleware(['auth', SeleccionarEmpresaMiddleware::class])->group(function () {
    ...
    // Excel
    Route::get('/excel/liquidaciones', [\App\Http\Controllers\LiquidacionesExcelController::class, 'descargar'])
    ...
    Route::get('/usuario-externos/importar', [UsuarioExternoImportController::class, 'showForm'])
    ->name('usuario_externos.import');
    Route::post('/usuario-externos/importar', [UsuarioExternoImportController::class, 'import'])
    ->name('usuario_externos.import.do');
    Route::post('/usuario-externos/{usuario}/reactivar', [UsuarioExternoController::class, 'reactivar'])
    ->name('usuario_externos.reactivar');
    // routes/web.php
    Route::get('/periodos', [\App\Http\Controllers\PeriodoUsuarioController::class, 'index'])->name('periodos.index');
    Route::get('/periodos/pendientes', [\App\Http\Controllers\PeriodoUsuarioController::class, 'pendientes'])
    ->name('periodos.pendientes');
    // Export de usuarios vigentes (período actual)
Route::get('/excel/usuarios-vigentes', [\App\Http\Controllers\UsuariosVigentesExcelController::class, 'descargar'])
    ...
    // routes/web.php (dentro del middleware autenticado)
    Route::prefix('recibos')->group(function () {
    // ...
    Route::get('/retiros-masivos', [\App\Http\Controllers\ReciboController::class, 'retirosMasivosForm'])
        ->name('recibos.retirosMasivos.form');

    Route::post('/retiros-masivos', [\App\Http\Controllers\ReciboController::class, 'retirosMasivosExport'])
    ...
    */
    Route::prefix('usuario_externos')->group(function () {
       ...
       // ✅ CORRECTO (sin duplicar el prefijo en la URL)
    ...
    */
    Route::prefix('recibos')->group(function () {
        ...
        Route::get('/exportaciones/{batch}/descargar', [\App\Http\Controllers\LiquidacionesExcelController::class, 'descargarLote'])
